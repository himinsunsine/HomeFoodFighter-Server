module.exports = {
    ...
    //request error
    CONTENT_EMPTY : { "isSuccess": false, "code": 400, "message": "리뷰를 입력하세요"},
    STAR_CHECK1 : { "isSuccess": false, "code": 400, "message": "별점이 0.5 미만입니다."},
    STAR_CHECK2 : { "isSuccess": false, "code": 400, "message": "별점이 0.5 단위가 아닙니다."},
